...
import listenerAdmin.LoginListener;

@SuppressWarnings("restriction")
public class LoginFrameAdmin extends JFrame implements Runnable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7635382088464340846L;
	private static LoginFrameAdmin loginFrameAdmin;
	private static JDialog loginDialog;
	private JTextField jtfUserName;
	private JPasswordField jpfPassword;

	public static LoginFrameAdmin instance()
	{
		if (loginFrameAdmin == null)
			loginFrameAdmin = new LoginFrameAdmin();
		return loginFrameAdmin;
	}
	...
	public LoginFrameAdmin()
	{
		...
		loginBg.setBounds(0, 0, (int) loginDialog.getWidth(), (int) loginDialog.getHeight());
		...
		jtfUserName.setSelectionColor(Color.white);
		jpfPassword.setSelectionColor(Color.white);
		jtfUserName.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 24));
		jpfPassword.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 24));

		LoginListener loginListener = new LoginListener(jtfUserName, jpfPassword, ensure, cancel);
