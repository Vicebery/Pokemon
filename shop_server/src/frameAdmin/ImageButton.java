...
public class ImageButton extends JButton implements MouseListener
{
	...
	public ImageButton(String btnname, String text)
	{
		...
		textPanel.setFont(new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 16));
		add(textPanel);
	}
	...
	{
		this(btnname, text);
		textPanel.setFont(new Font("Î¢ÈíÑÅºÚ", Font.BOLD, size));
	}
	...
	public void setFont(Font font)
	{
		...
		if (textPanel != null)
		{
			...
			textPanel.setSize(textPanel.getPreferredSize().width, textPanel.getHeight());
		}
	}
	...
	public void paint(Graphics g)
	{
		try
		{
			...
			if ("".equals(modal))
			{
				img = new ImageIcon(this.getClass().getResource("/images/" + name + ".png"));
			} else
			{
				img = new ImageIcon(this.getClass().getResource("/images/" + name + "_" + modal + ".png"));
			}
		...
		if (textPanel != null)
		{
			...
			g.drawString(textPanel.getText(), (int) (getWidth() - textPanel.getPreferredSize().getWidth()) / 2 + 1,
					getHeight() / 2 + 7);
			textPanel.paint(g);
		}
	}
